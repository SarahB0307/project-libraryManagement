...
int main(int argc, char** argv) {
    ...
    BiblioH* bibliotheque = charger_n_entrees_H(nom_fichier, nombre_lignes);
    if (bibliotheque == NULL) {
        fprintf(stderr, "Erreur lors du chargement de la bibliothèque.\n");
        return 1;
    }
    enregistrer_biblio_H(bibliotheque, "bibliotheque_enregistree.txt");
    int rep;
        char choix[256]; 
        ...
        do {
            ...
            switch (rep) {
                ...
                case 1:
                    ...
                    afficher_biblio_H(bibliotheque);
                    break;
                case 2: {
                    // Insérer un ouvrage
                    int num;
